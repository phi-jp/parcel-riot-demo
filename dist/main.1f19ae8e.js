...
riot.tag2('app', '<h1>{title}</h1> <ul> <li>bbbbbbbbb</li> <item each="{item in [1, 2, 3, 4]}" item="{item}"></item> </ul>', '', '', function (opts) {
...
},{"./app.tag":"tags/app.tag"}],"tags/items/item.tag":[function(require,module,exports) {
var riot = require('riot');

riot.tag2('item', '<h2>アイテム {opts.item} ですよー</h2>', '', '', function (opts) {});
},{"riot":"../node_modules/riot/riot.js"}],"tags/**/*.tag":[function(require,module,exports) {
module.exports = {
  "app": require("./../app.tag"),
  "items": {
    "item": require("./../items/item.tag")
  }
};
},{"./../app.tag":"tags/app.tag","./../items/item.tag":"tags/items/item.tag"}],"../package.json":[function(require,module,exports) {
module.exports = {
  "name": "parcel-riot-demo",
  "version": "1.0.0",
  "description": "",
  "main": "index.js",
  "scripts": {
    "dev": "parcel src/index.html --no-cache --public-url ./",
    "build": "parcel build src/main.js --no-cache",
    "watch": "parcel watch src/index.html --no-cache",
    "test": "echo \"Error: no test specified\" && exit 1"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/phi-jp/parcel-riot-demo.git"
  },
  "author": "",
  "license": "MIT",
  "bugs": {
    "url": "https://github.com/phi-jp/parcel-riot-demo/issues"
  },
  "homepage": "https://github.com/phi-jp/parcel-riot-demo#readme",
  "dependencies": {
    "firerest": "^0.1.6",
    "parcel-bundler": "^1.12.4",
    "parcel-plugin-riotjs": "git://github.com/riot/parcel-plugin-riot.git#1653eea7c25775fcafcf09ab5a1ffb68d0bc0826",
    "riot": "^3.13.2"
  }
};
...
global.Firestore = _firerest.default; // // package.json 読めるかの実験
...
_riot.default.mount('*');
},{"riot":"../node_modules/riot/riot.js","firerest":"../node_modules/firerest/firerest.js","./tags/*.tag":"tags/*.tag","./tags/**/*.tag":"tags/**/*.tag","../package.json":"../package.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
